                  ...
                  <div className="step">
                      <div className="career-info-container  second">
                          <ul className = 'career-info-path'>
                              ...
                              <li className="mid">Ensure you have SOL in your wallet to swap for $CHIPPO. If you don’t have any SOL, you can purchase SOL from an exchange or use a cross-chain swap service to send SOL to your wallet.</li>
                          </ul>
                      </div>
                  </div>
              </div>
                  ...
                  <div className="step">
                      <div className="career-info-container">
                          <ul className = 'career-info-path'>
                              ...
                              <li className="mid">Visit Jup.ag in Google Chrome or use the browser within your Phantom app. Connect your wallet, paste the $CHIPPO token address into Jupiter, and confirm the swap. When prompted by Phantom for a wallet signature, approve it.</li>
